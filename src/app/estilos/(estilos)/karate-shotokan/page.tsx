    ...
    return(
        <main className={styles.article}>
            ...
            <section className={styles.article__container}>
                ...
                <p>En cuanto a su ténica, es caracterizado sobre todo por hacer uso de las posiciones bajas durante gran parte de su ejecución, buscando más estabilidad y ganar potencia. Por tanto sirve para ejercitar la zona ded las caderas y practicar las contracciones musculares. El Shotokan hace uso de las patadas altas y de los movimientos de larga distancia. Es por esto que solo considera un estilo de karate &quot;más japonés&quot;.</p>
                <h2 className={styles.article__subtitle}>Katas de Shokotan</h2>

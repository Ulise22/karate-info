    ...
    return(
        <main className={styles.famoso}>
            ...
            <section className={styles.famoso__article}>
                ...
                <p>White comenzó su entrenamiento durante su niñez en las artes marciales tradicionales del Jiu-jitsu y del <Link href='/estilos/karate-do'>Karate-Do</Link> a la edad de siete años, para después dedicarse a otras variantes y estilos.</p>

        ...
        <main className={styles.article}>
            ...
            <section className={styles.article__container}>
                ...
                <ul>
                    ...
                    <li>5. <b>La Mezcla de Estilos:</b> Con el paso del tiempo, otras formas de karate se fueron desarrollando en Okinawa, con diferentes ténicas y enfoques como lo son <Link href='/estilos/gojuryu'>Goju-Ryu</Link>, <Link href='/estilos/shorinji-ryu'>Shorin-Ryu</Link> o el <b>Uechi-Ryu</b>. </li>

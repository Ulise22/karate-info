...
export default function KarateJutsu () {
    return(
        <main className={styles.article}>
            ...
            <section className={styles.article__container}>
                ...
                <p>Podemos entencer entonces que, el <b>Karate-jutsu</b> es la aplicación de las técnicas del karate en un contexto de un combate real, mientras que el <Link href='/articulos/karate-do'>Karate-do</Link> es el que se utiliza en la práctica para desarrollar el caracter de los participantes.</p>
            </section>
        </main>
    )
}